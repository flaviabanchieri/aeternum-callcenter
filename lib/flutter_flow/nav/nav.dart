...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? LoadWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/leadsGestor',
          requireAuth: true,
          builder: (context, params) => LeadsGestorWidget(),
        ),
        FFRoute(
          name: 'Login',
          path: '/login',
        ...
        FFRoute(
          ...
          path: '/infoLead',
          requireAuth: true,
          builder: (context, params) => InfoLeadWidget(
        ...
        FFRoute(
          ...
          path: '/homePageGestor',
          requireAuth: true,
          builder: (context, params) => HomePageGestorWidget(),
        ),
        FFRoute(
          name: 'CriarProduto',
          path: '/criarProduto',
        ...
        FFRoute(
          name: 'detalhesAtendente',
          path: '/detalhesAtendente',
          requireAuth: true,
          builder: (context, params) => DetalhesAtendenteWidget(
            atendenteId: params.getParam(
              'atendenteId',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => AlterarSenhaUsuarioWidget(),
        ),
        FFRoute(
          name: 'Configuracoes',
          path: '/configuracoes',
        ...
        FFRoute(
          ...
          path: '/cadastroAtendente',
          builder: (context, params) => CadastroAtendenteWidget(),
        ),
        FFRoute(
          name: 'EditarProduto',
          path: '/editarProduto',

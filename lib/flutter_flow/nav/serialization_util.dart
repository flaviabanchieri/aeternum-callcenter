    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case LeadStatusRow:
            return LeadStatusRow(data);
          case ViewHistoricoRow:
            return ViewHistoricoRow(data);
          case ProdutoCategoriaRow:
            return ProdutoCategoriaRow(data);
          case LeadRow:
            return LeadRow(data);
          ...
          case UsuarioPontoRow:
            return UsuarioPontoRow(data);
          case LeadComprovantesRow:
            return LeadComprovantesRow(data);
          case VendasViewRow:
            return VendasViewRow(data);
          case ProdutoRow:
            return ProdutoRow(data);
          case ViewLigacoesRow:
            return ViewLigacoesRow(data);
          case LigacoesRow:
            return LigacoesRow(data);
          default:
            return null;
        }
